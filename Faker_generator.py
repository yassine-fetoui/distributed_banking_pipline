...
def run_iteration():
    ...
    for customer_id in customers:
        for _ in range(ACCOUNTS_PER_CUSTOMER):
            ...
            cur.execute(
                "INSERT INTO account (customer_id, account_type, balance, currency) VALUES (%s, %s, %s, %s) RETURNING id",
    ...
    for _ in range(NUM_TRANSACTIONS):
        ...
        cur.execute(
            "INSERT INTO transaction (account_id, transaction_type, amount, related_account_id, status) VALUES (%s, %s, %s, %s, 'COMPLETED')",
