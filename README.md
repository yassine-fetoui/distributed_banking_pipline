...
graph LR
    ...
    -->|Debezium CDC| B{{"Kafka<br/>Message Bus"}}

    B 
    -->|Python Consumer| C[("MinIO<br/>Lake: Bronze")]

    C 
    -->|Airflow DAGs| D[("Snowflake / PG<br/>Warehouse: Silver")]

    D 
    -->|dbt Transformations| E[("Analytics Layer<br/>Gold")]
